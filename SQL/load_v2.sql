...
DROP TABLE IF EXISTS quest_detail;
...
INSERT INTO bd_questio VALUES (8, 2, 'Títols de les pel·lícules en anglès (ordre alfabètic, les 10 primeres).', 2, 'select title from film f, language l where f.language_id=l.language_id and name=''German'' order by title limit 10;');
