...
INSERT INTO bd_questio VALUES (21, 10, 'trobar els empleats que s''han contractat a partir del 1999, ordenats per antiguitat (id, nom, cognom, data de contractació)', 1, 0,'SELECT employee_id, first_name, last_name, hire_date FROM employees WHERE hire_date >= \'1999-01-01\' ORDER BY hire_date ASC');
...
INSERT INTO bd_questio VALUES (84, 9, 'Llistar tot el vestuari que surt en l''obra de la Caputxeta del 2021, ordenat per id_loc (hab, loc, vestuari, pers). Utilitzar USING.', 1, 0,'SELECT loc, hab, vestuari, pers rol FROM OBRA o\nINNER JOIN PERSONATGE p USING(id_obra)\nINNER JOIN VEST_PERS vp USING(id_pers)\nINNER JOIN VESTUARI v USING(ref)\nINNER JOIN LOCALITZACIO l USING(id_loc)\nWHERE obra=\'La Caputxeta Vermella 2021\'\nORDER BY l.id_loc');
...
INSERT INTO bd_questio VALUES (210, 2, 'Llista, ordenada per cognom, de tots els noms i cognoms tant de staff com dels actors (union).', 1, 0,'SELECT first_name, last_name FROM staff\nunion\nSELECT first_name, last_name FROM actor\norder by last_name, first_name');
