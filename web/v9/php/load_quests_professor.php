...
$sql = "select q.id_quest, quest, count(aq.id_alumne) as num from ((alumne_quest aq right outer join quest q on q.id_quest=aq.id_quest) right outer join alumne a ON aq.id_alumne=a.id_alumne and a.actiu=1) , professor p where q.id_professor=p.id_professor and p.email='$email' group by q.id_quest";
