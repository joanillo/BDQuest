...
function processar() {
    ...
    if (arr_sql_alumne[0].toLowerCase() != arr_solucio[0].toLowerCase()) {
        ...
        return;
    } else if (arr_solucio[0].toLowerCase()=="create" && ((arr_sql_alumne[0]+arr_sql_alumne[1]+arr_sql_alumne[2]).toLowerCase() != (arr_solucio[0]+arr_solucio[1]+arr_solucio[2]).toLowerCase())) {
    //cas específic CREATE TABLE xxx, ALTER
        alert('PISTA: CREATE TABLE ' + arr_solucio[2]);
        return;
    }  else if (arr_solucio[0].toLowerCase()=="alter" && ((arr_sql_alumne[0]+arr_sql_alumne[1]+arr_sql_alumne[2]).toLowerCase() != (arr_solucio[0]+arr_solucio[1]+arr_solucio[2]).toLowerCase())) {
        alert('PISTA: ALTER TABLE ' + arr_solucio[2]);
        return;
    }  else if (arr_solucio[0].toLowerCase()=="drop" && ((arr_sql_alumne[0]+arr_sql_alumne[1]+arr_sql_alumne[2]).toLowerCase() != (arr_solucio[0]+arr_solucio[1]+arr_solucio[2]).toLowerCase())) {
    ...
    xmlhttp.onreadystatechange=function()
    {
        if (xmlhttp.readyState==4 && xmlhttp.status==200) {
            ...
            if (obj.data.indexOf("Error")==0 || obj.data.indexOf("Warning")==0 || obj.data.indexOf("Affected")==0 || obj.data.indexOf("OK")==0 || obj.data.indexOf("INCORRECTE")==0) {
    ...
    xmlhttp.send("bd=" + document.forms[0].bd.value + "&solucio=" + document.forms[0].solucio.value + "&sql_alumne=" + document.forms[0].sql_alumne.value + "&id_quest=" + id_quest + "&num_pregunta=" + arr_preguntes[num_pregunta-1] + "&estat_quest=" + estat_quest + "&current_id_alumne_quest=" + current_id_alumne_quest + "&id_alumne=" + id_alumne);
}
