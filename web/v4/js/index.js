...
function processar(bd, solucio, sql_alumne) {
    ...
    xmlhttp.send("bd=" + bd + "&solucio=" + solucio + "&sql_alumne=" + sql_alumne + "&id_quest=" + id_quest + "&num_pregunta=" + arr_preguntes[num_pregunta-1] + "&estat_quest=" + estat_quest + "&current_id_usuari_quest=" + current_id_usuari_quest);
}
...
function load_quests() {
    ...
    xmlhttp.onreadystatechange=function()
    {
        if (xmlhttp.readyState==4 && xmlhttp.status==200) {
            ...
            //alert(document.forms[0].id_usuari.value);
            if (document.forms[0].id_usuari.value == "") {
